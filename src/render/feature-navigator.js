...
export const FEATURE_FUTURE_OPTIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    detail: "additional public sources with explicit provenance and freshness",
    status: "OPTIONAL GATE",
    routeId: "gateway",
    routeLabel: "OPEN PUBLIC-SOURCE BOUNDARY",
  }),
  Object.freeze({
    id: "xr-host",
    label: "XR HOST",
...
export const FEATURE_HANDOFF_LINKS = Object.freeze({
  ...
  "launch-distribution": Object.freeze(["asset-token", "asset-market", "white-paper"]),projections: Object.freeze(["reality-lens", "block-world", "white-paper"]),
  "web-ai": Object.freeze(["gateway", "world-events", "luna-companion"]),
  ...
  "luna-companion": Object.freeze(["neural-mesh", "rooms", "academy", "web-ai"]),
...
const FEATURE_SURFACE_ROUTES = Object.freeze({
