...
export const FEATURE_SURFACE_ROUTES = Object.freeze({
  ...
  "web-ai": Object.freeze([
    ...
    Object.freeze(["COMPUTE TAB", "provider-neutral usage meter · verified-spend reward rehearsal"]),
    Object.freeze(["ECONOMIC LOOP", "provider → receipt → PAYCORE → T402 → reward → ledger → Lens"]),
