import { createProjectionEnvelope } from "./view-state.js?v=20260922-cache2";
import { createCipherContribution } from "../domains/cipher.js?v=20260922-cache2";
import { createContractsMarketsContribution } from "../domains/contracts-markets.js?v=20260922-cache2";
import { createAssetTokenContribution } from "../domains/asset-token.js?v=20260922-cache2";
import { createLaunchDistributionPreview } from "../domains/distribution-registry.js?v=20260922-cache2";
import { createLedgerProofContribution } from "../domains/ledger-proof.js?v=20260922-cache2";
import { createLiveGatewayContribution } from "../domains/live-gateway.js?v=20260922-cache2";
import { createMatterForgeContribution } from "../domains/matter-forge.js?v=20260922-cache2";
import { createNeuralMeshContribution } from "../domains/neural-mesh.js?v=20260922-cache2";
import { createPaycoreContribution } from "../domains/paycore.js?v=20260922-cache2";
import { profileProjection } from "../domains/profile.js?v=20260922-cache2";
import { createRoomsContribution } from "../domains/rooms.js?v=20260922-cache2";
import { createSocialExplorerContribution } from "../domains/social-explorer.js?v=20260922-cache2";
import { createT402Contribution } from "../domains/t402.js?v=20260922-cache2";
import { createBlockWorldContribution } from "../domains/block-world.js?v=20260922-cache2";
import { createBlockMigrationManifest } from "../domains/block-migration.js?v=20260922-cache2";
import { createArenaGamesContribution } from "../domains/arena-games.js?v=20260922-cache2";
import { createAcademyContribution } from "../domains/academy.js?v=20260922-cache2";
import { createNftAtelierContribution } from "../domains/nft-atelier.js?v=20260922-cache2";
import { createFrozenRelicsContribution } from "../domains/frozen-relics.js?v=20260922-cache2";
import { createMuseAgentContribution } from "../domains/muse-agent.js?v=20260922-cache2";
import { createBotPlazaContribution } from "../domains/bot-plaza.js?v=20260922-cache2";
import { createContractAtelierContribution } from "../domains/contract-atelier.js?v=20260922-cache2";
import { createLunaCompanionContribution } from "../domains/luna-companion.js?v=20260922-cache2";
import { createWardrobeAtelierContribution } from "../domains/wardrobe-atelier.js?v=20260922-cache2";
import { createWhitePaperContribution } from "../domains/white-paper.js?v=20260922-cache2";
import { createGestureLensContribution } from "../domains/gesture-lens.js?v=20260922-cache2";
...
export function createLivingRealityProjection({ projectedAt = LIVING_REALITY_SAMPLE_TIME } = {}) {
  ...
  const frozenRelics = createFrozenRelicsContribution({ updatedAt: projectedAt });
  const museAgent = createMuseAgentContribution({ updatedAt: projectedAt });
  const botPlaza = createBotPlazaContribution({ updatedAt: projectedAt });
