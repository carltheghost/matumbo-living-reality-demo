...
// Final presentation latch: optional/async mounts must not be able to steal the
// clean root landing after the Reality Assembly has been opened. The assembly
// is opened once the render loop exists, then checked on the next frame and
// shortly after boot. Explicit feature/panel/hash routes are never touched.
if (cleanRealityLanding) {
  realityAssembly.open();
